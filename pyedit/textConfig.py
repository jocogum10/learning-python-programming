...
# saveUseKnownEncoding: 0=No, 1=Yes for Save only, 2=Yes for Save and SaveAs;
...
openAskUser = True      #2 if True, try user input next (prefill with defaults)
...
saveAskUser = True          #2 if True, try user input next (prefill with known?)
