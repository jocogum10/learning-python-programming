...
def client1():
    ...
    for i in range(3):
        ...
        sys.stdout.flush()                              # else buffered till exists!
...
def client4():
    mypid = os.getpid()
    redirectBothAsServer()          # im actually the socker server in this mode
    for i in range(3):
        data = input()                                  # input from socket: flushes!
...
def client5():
    mypid = os.getpid()
    s = redirectBothAsClient()                  # im the socket client in this mode
    for i in range(3):
        data = input()                         # input from socket: flushes!
        print('client %s got [%s]' % (mypid, data))     # print to socket
        sys.stdout.flush()                              # else last buffered till exit!
...
################################################################################
# test by number of command-line
################################################################################
...
if __name__ == '__main__':
    ...
    client()                                            # reset streans in client
