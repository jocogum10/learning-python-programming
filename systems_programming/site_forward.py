...
"""
import os
servername = 'learning-python.com'               # where site is relocating tobytes
homedir = 'books'                               # where site will be rooted
sitefilesdir = r'F:\programming_python\systems_programming'       # where site files live locally
uploaddir = r'F:\programming_python\systems_programming'          # where to store forward files
