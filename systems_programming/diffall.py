...
Recursive directory tree comparison: report unique files that exists in only
...
def comparetrees(dir1, dir2, diffs, verbose=True):
    """
    ...
    # same name but not both files or difs?
    for name in missed:
