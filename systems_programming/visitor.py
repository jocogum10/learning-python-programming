"""
################################################################################
Test: "python visitor.py dir testmask [string]". Uses classes and
...
visitor_*/.py subclasses use cases; frameworks should generally use _X pseudo
...
class FileVisitor:
    ...
    override arg/attribute is optional subclass-specific state;
...
class SearchVisitor(FileVisitor):
    """
    Seach files at and below startDir for a string;
