"""
Use: "python visitor_replace.py rootdir fromStr toStr".
...
visitor_edit.py run an editor for you to verify and make changes, and so
is safer; use visitor_collect.py to simplify collect matched files list;
